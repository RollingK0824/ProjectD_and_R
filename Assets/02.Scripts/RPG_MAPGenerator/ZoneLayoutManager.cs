...
public class ZoneLayoutManager : MonoBehaviour
{
    ...
    [Header("구역 갯수")][SerializeField] int numberOfZones;
    [Header("구역 사이즈")][SerializeField] Vector2Int Size;

    [Header("방 생성 밀도")][Range(0.1f, 1f)][SerializeField] float roomDensity = 0.4f;
    [Header("구역 별 그리그 거리")][SerializeField] int gapBetweenZones = 0;
    [Header("구역 별 연결 통로 갯수")][SerializeField] int connectionsBetweenZones = 1;

    [Header("공통 설정")]
    [SerializeField] GameObject roomPrefab;
    [SerializeField] GameObject MapParent;
    [SerializeField] Color[] zoneColors;
